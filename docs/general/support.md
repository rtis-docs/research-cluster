...
!!! overview "On this Page"
      - Support channels
      - What information to provide when requesting technical support
      - Best practices for providing an example test dataset

## Support channels

Email the eResearch Support team at **{{ support_email }}** or find support on **[the Research Computing Teams Channel](https://teams.microsoft.com/l/team/19%3AwY-QPCGhXz_nHt4-0C7Ltz7gdVAmE_1fDfmgFO4bnHs1%40thread.tacv2/conversations?groupId=de270594-2da5-4354-b319-57f8894c89f3&tenantId=0225efc5-78fe-4928-b157-9ef24809e9ba>)**.
...
To request technical support, please provide the following information:
  ...
  * **Example test dataset**: If possible, provide a minimal, self-contained example dataset that demonstrates the issue. This will allow us to reproduce the problem and test potential solutions. See [best practices](#best-practices-for-providing-an-example-test-dataset) below.
...
By following these guidelines, you will help us provide you with efficient and effective technical support. If you have any questions or concerns, please don't hesitate to reach out to us.

!!! related-pages "What's next?"
      - Looking for something else? See the FAQ drop-down on the contents panel to the left.
      - [Home Page](../index.md)
