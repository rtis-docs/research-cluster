...
A Software Carpentry ([https://software-carpentry.org](https://software-carpentry.org)) workshop is a hands-on training that covers the core skills needed to be productive in a small research team. 
...
{% include  "other_services/training/child/swc/*" %}
...
Data Carpentry's ([https://datacarpentry.org](https://datacarpentry.org)) focus is on the introductory computational skills needed for data management and analysis 
...
{% include  "other_services/training/child/dc/*" %}
