...
| :-- | :-- | :-- |
<<<<<<< HEAD
| `--partition` | `aoraki` | 27 general-purpose nodes. See [Partitions](../../getting_started/overview.md#partitions). |
=======
...
<<<<<<< HEAD
    - For the partitions, hardware and limits, see the [Cluster Overview](../../getting_started/overview.md)
=======
