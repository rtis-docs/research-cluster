...
DeepLabCut is made available on the cluster as a shared [Apptainer](../software_environments/apptainer.md) container image. Scripted/commandline access requires Python to be run within the context of the container.
