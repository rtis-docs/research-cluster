...
CCP4 is made available on the cluster as a shared [Apptainer](../software_environments/apptainer.md) container image. To run CCP4 binaries within the container, prefix any command with the name of the apptainer image, `ccp4.sif`.
...
See [SBGrid](../software_environments/sbgrid.md)
